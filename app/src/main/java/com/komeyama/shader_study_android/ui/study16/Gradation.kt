...
class Gradation(
    ...
    init {
        ...
        val fragmentShader = ShaderUtils.loadShader(GLES20.GL_FRAGMENT_SHADER, LinearInterpolationShaderCodes.CIRCLE)
    ...
    override fun handleFragmentParameter() {
        ...
        GLES20.glGetUniformLocation(circleProgram, "vResolution").also { resolutionHandle ->
            GLES20.glUniform2fv(resolutionHandle, 1, resolution, 0)
        }
    }
}